...
#lien = f"https://api.openweathermap.org/data/2.5/weather?lat={lat}&lon={lon}&dt={heure_demandee}&appid={key}"
...
"""while heure_demandee<1624564800:
    liste.append(dico_24_06["hourly"][str(heure_demandee)]['clouds'])
    heure_demandee+=3600"""
print(dico_24_06)
